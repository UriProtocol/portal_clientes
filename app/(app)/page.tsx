...
export default function Dashboard() {
  ...
  return (
    <>
      <motion.h1
        className="font-semibold text-5xl text-center text-black/90"
        initial={{
          y: -10,
          opacity: 0
        }}
      ...
      <motion.h2
        className=" text-center mt-6 text-xl text-datia-gray"
        initial={{
          y: -10,
          opacity: 0
        }}
          ...
          <Card>
            ...
            <Card.Footer>
              <Link href={"/facturas"} className="mx-auto mt-1">
                <Button size="lg" className="bg-datia-secondary hover:opacity-90 text-white">
                  Ver facturas
                  <FaArrowRight />
                </Button>
              </Link>
